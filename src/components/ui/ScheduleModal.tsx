    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-background rounded-xl shadow-2xl w-full max-w-sm md:max-w-3xl max-h-[120vh] border border-primary/20 overflow-y-auto max-sm:scale-[0.7] sm:scale-100"
